...
import static util.Constants.ACE;
import static util.Constants.ACE_FLUSH;
import static util.Constants.CAKE;
import static util.Constants.CIRCUMFERENCE_SEVEN;
import static util.Constants.CLUB;
import static util.Constants.DECK_SIZE;
import static util.Constants.DIAMOND;
import static util.Constants.EIGHT;
import static util.Constants.EIGHT_FLUSH;
import static util.Constants.EQUITY_EIGHT;
import static util.Constants.EQUITY_FIVE;
import static util.Constants.EQUITY_FOUR;
import static util.Constants.EQUITY_SEVEN;
import static util.Constants.EQUITY_SIX;
import static util.Constants.EQUITY_THREE;
import static util.Constants.EQUITY_TWO;
import static util.Constants.FIVE;
import static util.Constants.FIVE_FLUSH;
import static util.Constants.FOUR;
import static util.Constants.FOUR_FLUSH;
import static util.Constants.HEART;
import static util.Constants.JACK;
import static util.Constants.JACK_FLUSH;
import static util.Constants.KING;
import static util.Constants.KING_FLUSH;
import static util.Constants.MAX_FLUSH_CHECK_SUM;
import static util.Constants.MAX_FLUSH_KEY_INT;
import static util.Constants.MAX_KEY_INT;
import static util.Constants.MAX_NONFLUSH_KEY_INT;
import static util.Constants.MAX_NUMBER_OF_PLAYERS;
import static util.Constants.NINE;
import static util.Constants.NINE_FLUSH;
import static util.Constants.NON_FLUSH_BIT_SHIFT;
import static util.Constants.NOT_A_FLUSH;
import static util.Constants.NUMBER_OF_SUITS;
import static util.Constants.QUEEN;
import static util.Constants.QUEEN_FLUSH;
import static util.Constants.SEVEN;
import static util.Constants.SEVEN_FLUSH;
import static util.Constants.SIX;
import static util.Constants.SIX_FLUSH;
import static util.Constants.SPADE;
import static util.Constants.SUIT_BIT_MASK;
import static util.Constants.TEN;
import static util.Constants.TEN_FLUSH;
import static util.Constants.THREE;
import static util.Constants.THREE_FLUSH;
import static util.Constants.TWO;
import static util.Constants.TWO_FLUSH;
import static util.Constants.UNVERIFIED;
